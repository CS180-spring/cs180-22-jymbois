...
const SettingScreen = () => {
	...
	const [isPushNotificationsEnabled, togglePushNotifications] =
		usePushNotificationToggle(false);
				...
				>
					<View style={styles.modalContainer2}>
						<Text style={styles.modalTitle2}>
							Hope you are Having Fun! See you in ...{" "}
						</Text>
...
const createThemedStyles = (isDarkMode) => {
	...
	return StyleSheet.create({
		...
		modalContainer: {
			// change this if u want to change the background color of the whole countdown page
			flex: 1,
			justifyContent: "center",
			alignItems: "center",
